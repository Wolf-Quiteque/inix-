...
(function($) {
    ...
    if (clock.length) {
        if (clock.hasClass('js-timer-elapsed')) {
            // Temporizador expirado/contagem regressiva
            ...
            clock.countdown(date, {
                ...
                var output = [
                    ...
                    '<div class="counter-box first"><div class="number">' + Math.abs(outputYears) + '</div><span>' + outputYearsLabel + '</span></div>', // Anos
                    '<div class="counter-box first"><div class="number">' + Math.abs(outputMonths) + '</div><span>Meses</span></div>', // Meses
                    '<div class="counter-box first"><div class="number">' + Math.abs(outputDays) + '</div><span>' + outputDaysLabel + '</span></div>', // Dias
                    '<div class="counter-box"><div class="number">%H</div><span>Horas</span></div>', // Horas
                    '<div class="counter-box"><div class="number">%M</div><span>Minutos</span></div>', // Minutos
                    '<div class="counter-box last"><div class="number">%S</div><span>Segundos</span></div></div>', // Segundos
                    '</div>'
                ].join('\n');
                $(this).html(
            ...
            var date = moment('2024-12-15 00:00:00').format('YYYY/MM/DD HH:mm:ss');
            clock.countdown(date).on('update.countdown', function(event) {
                var output = [
                    '<div class="counter-container">',
                    '<div class="counter-box first"><div class="number">%-D</div><span>Dia%!d</span></div>', // Dias
                    '<div class="counter-box"><div class="number">%H</div><span>Horas</span></div>', // Horas
                    '<div class="counter-box"><div class="number">%M</div><span>Minutos</span></div>', // Minutos
                    '<div class="counter-box last"><div class="number">%S</div><span>Segundos</span></div></div>' // Segundos
                ].join('\n');
